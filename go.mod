...
require (
	...
	github.com/DataDog/dd-trace-go/contrib/google.golang.org/grpc/v2 v2.9.2
	github.com/DataDog/dd-trace-go/contrib/gorm.io/gorm.v1/v2 v2.9.2
	github.com/DataDog/dd-trace-go/contrib/labstack/echo.v4/v2 v2.9.2
	...
	github.com/coopnorge/mage v0.37.1
