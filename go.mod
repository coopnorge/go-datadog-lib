...
require (
	...
	gopkg.in/DataDog/dd-trace-go.v1 v1.74.4
...
require (
	...
	github.com/DataDog/dd-trace-go/contrib/database/sql/v2 v2.2.2-rc.1 // indirect
	github.com/DataDog/dd-trace-go/contrib/google.golang.org/grpc/v2 v2.2.2-rc.1 // indirect
	github.com/DataDog/dd-trace-go/contrib/gorm.io/gorm.v1/v2 v2.2.2-rc.1 // indirect
	github.com/DataDog/dd-trace-go/contrib/labstack/echo.v4/v2 v2.2.2-rc.1 // indirect
	github.com/DataDog/dd-trace-go/contrib/net/http/v2 v2.2.2-rc.1 // indirect
	github.com/DataDog/dd-trace-go/instrumentation/testutils/grpc/v2 v2.2.2-rc.1 // indirect
