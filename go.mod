...
require (
	...
	github.com/DataDog/dd-trace-go/contrib/database/sql/v2 v2.10.0
	github.com/DataDog/dd-trace-go/contrib/google.golang.org/grpc/v2 v2.10.0
	github.com/DataDog/dd-trace-go/contrib/gorm.io/gorm.v1/v2 v2.10.0
	github.com/DataDog/dd-trace-go/contrib/labstack/echo.v4/v2 v2.10.0
	github.com/DataDog/dd-trace-go/contrib/net/http/v2 v2.10.0
	github.com/DataDog/dd-trace-go/v2 v2.10.0
	github.com/coopnorge/go-logger v0.15.8
	github.com/coopnorge/mage v0.38.1
